...
bare = open("avqe/data/avqe_sup_err_run_v_alpha_new", "rb")
...
plt.grid(True)
plt.savefig('avqe/plots/avqe_vs_error_sup_new.png', bbox_inches='tight')
plt.clf()
...
plt.grid(True)
plt.savefig('avqe/plots/avqe_vs_runs_sup_new.png', bbox_inches='tight')
plt.clf()



plt.plot(depths, np.asarray(failures)*100, linewidth = 2, color = colours[0])
plt.xticks(size = tick_size)
plt.yticks(size = tick_size)
...
plt.grid(True)
plt.savefig('avqe/plots/avqe_failures_sup_new.png', bbox_inches='tight')
plt.clf()
exit()
