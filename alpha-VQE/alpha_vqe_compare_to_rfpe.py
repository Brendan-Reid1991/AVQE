...
for _ in range(10000):
    ...
    ss50 = aqpe(phi=phi, sigma=pi/2, nSamples=50, alpha = 1, update = 1)
    ss100 = aqpe(phi=phi, sigma=pi/2, nSamples=100, alpha = 1, update = 1)
    ss400 = aqpe(phi=phi, sigma=pi/2, nSamples=400, alpha = 1, update = 1)
...
save_here = open("alpha-VQE/data/alpha_vqe_rfpe_compare", "wb")
...
plt.ylim(10**-15, 10**0)
plt.legend()
plt.savefig("alpha-VQE/plots/aqpe_test.pdf")
plt.clf()
